...
function init(){
    ...
    if(dark){
        html += `
        <div id="nav" class="mdui-toolbar mdui-container-fluid mdui-text-color-white-text">
        </div>`;
    }else{
        html += `
...
html += `
        ...
        <div id="content" class="mdui-container-fluid"> 
        </div>`;
    $('body').html(html);
}
...
function list(path){
    ...
    if(search){
        if(dark){content += `<div class="mdui-textfield"><input class="mdui-textfield-input mdui-text-color-white-text" id="searchInput" onkeyup="searchOnlyActiveDir()" type="text" placeholder="Filtrele..."></input></div>`;
        }else{content += `<div class="mdui-textfield"><input class="mdui-textfield-input" id="searchInput" onkeyup="searchOnlyActiveDir()" type="text" placeholder="Filtrele..."></input></div>`;}
    }
...
function file_video(path){
	...
	var playBtn = `
      <button class="mdui-btn mdui-ripple mdui-color-theme-accent" mdui-menu="{target:'#external-player'}">
        <i class="mdui-icon material-icons">&#xe039;</i> Player ile Oynat
	  </button>
